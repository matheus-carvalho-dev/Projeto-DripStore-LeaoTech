...
const ProductInfo = ({product, currentSize, currentColor, setCurrentColor, setCurrentSize}) => {
  return (
      
        <div className="h-100 d-flex flex-column justify-content-between align-content-between ms-3">
